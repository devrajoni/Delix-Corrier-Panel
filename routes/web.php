...
use App\Http\Controllers\Admin\SMSCreditController;
use App\Http\Controllers\Admin\BranchManagerDashboardController;
use Mcamara\LaravelLocalization\Facades\LaravelLocalization;
use App\Http\Controllers\Admin\WebsiteSetting\WebsiteFaqController;
...
Route::group(['middleware' => ['isWebsite'], 'prefix' => localeRoutePrefix()], function () {
...
Route::group(['middleware' => 'XSS'], function () {
    Route::group(['prefix' => localeRoutePrefix()], function () {
        ...
        Route::middleware(['LogoutCheck'])->group(function () {
            ...
            Route::get('login-as/{key}', [AuthController::class, 'login_as'])->name('login.as');
        ...
        // after login
        Route::middleware(['LoginCheck'])->group(function (): void {
            Route::get('admin/dashboard', action: [DashboardController::class, 'index'])->name('dashboard');
            Route::get('free-package', [DashboardController::class, 'freePackage'])->name('free.package');

        Route::middleware(['expireDateCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                //  sms preference
                Route::get('sms/sms-preference', [PreferenceController::class, 'smsPreference'])->name('sms.preference.setting')->middleware('PermissionCheck:preference');
                ...
                // Route::get('email/email-setting', [PreferenceController::class, 'emailSetting'])->name('email.preference.setting');
                ...
                Route::get('sms-history', [SMSHistoryController::class, 'index'])->name('sms.history')->middleware('PermissionCheck:sms.history');
                Route::get('sms-credit', [SMSCreditController::class, 'index'])->name('sms.credit')->middleware('PermissionCheck:sms.credit');
                ...
                //admin panel setting
                Route::get('setting/white-level-setting', [SystemSettingController::class, 'whiteLevelSetting'])->name('admin.white-level.setting')->middleware('panelPermission');
                Route::post('setting/white-level-setting', [SystemSettingController::class, 'updateSetting'])->name('admin.white-level.setting');
                ...
                Route::post('otp-setting', [PreferenceController::class, 'saveSMSSetting'])->name('otp.setting');
                ...
                //cron
                Route::get('sms/status', [PreferenceController::class, 'smsStatusUpdate'])->name(name: 'sms.status.update');
                ...
                Route::get('sms/setting', action: [PreferenceController::class, 'smsSetting'])->name('sms.setting')->middleware('GlobalPermissionCheck:sms_gateway');;

            });

            // superadmin
            Route::middleware(['systemSettingCheck'])->group(function () {
                Route::prefix('super-admin')->group(function () {
                    ...
                    Route::get('google-recaptcha', [WebsiteSettingController::class, 'recaptcha'])->name('google.recaptcha');
