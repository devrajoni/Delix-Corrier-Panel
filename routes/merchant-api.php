...
Route::group(['prefix' => '/merchant'], function () {
    ...
    Route::middleware(['jwt.verify','merchant.apikey'])->group(function () {
        ...
        Route::post('export', [ParcelController::class, 'export']);
        Route::get('charge', [ChargeController::class, 'charge']);
        Route::get('packaging-charge', [ChargeController::class, 'packagingCharge']);
        ...
        Route::get('all-mfs', [MFSController::class, 'allMfs']);
        Route::post('mfs-update', [MFSController::class, 'updateMfs']);
        Route::post('mfs-store', [MFSController::class, 'storeMfs']);
    });
});
