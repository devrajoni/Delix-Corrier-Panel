...
class CreatePermissionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $attributes = [
            ...
            'sms_setting'     => ['read' =>  'sms_setting_read', 'sms_credit' =>  'sms.credit', 'update' =>  'sms_setting_update', 'send_bulk_sms' => 'sms_campaign_message_send', 'send_sms' => 'custom_sms_send'],
            ...
            'settings'        => ['read' =>  'settings_read','charge_update' => 'charge_setting_update', 'pickup_and_delivery_time_update' => 'pickup_and_delivery_time_setting_update', 'preference_update' => 'preference_setting_update', 'panel_setting' => 'panel_setting', 'preference' => 'preference', 'payment_method' => 'payment_method'],
            'email_template'  => ['read' =>  'email_template_read', 'create' => 'email_template_create', 'update' => 'email_template_update', 'delete' => 'email_template_delete', 'email_configuration' => 'email_configuration'],
            ...
            'subscription'    => ['manage_plan'   => 'manage.plan', 'manage_domain' => 'manage.domain', 'usage'   => 'usage', 'mobile_app'   => 'mobile.app','plan_limitation'   => 'plan.limitation',],
            'system_setting'  => ['storage_setting'   => 'storage_setting', 'pusher_setting' => 'pusher_setting', 'cron_setting' => 'cron_setting', 'sms_gateway' => 'sms_gateway', 'server_info'   => 'server_info', 'server_update' => 'server_update', 're_captcha_setting' => 're_captcha_setting'],
            ...
            'website_setting' => [
                ...
                'partner_logo_view'         => 'partner_logo.index',
                'partner_logo_create'       => 'partner_logo.create',
                'partner_logo_edit'         => 'partner_logo.edit',
                'partner_logo_delete'       => 'partner_logo.destroy',

                'news_and_event_view'       => 'news_and_event.index',
                'news_and_event_create'     => 'news_and_event.create',
                'news_and_event_edit'       => 'news_and_event.edit',
                'news_and_event_delete'     => 'news_and_event.destroy',

                'about_view'                => 'about.index',
                'about_create'              => 'about.create',
                'about_edit'                => 'about.edit',
                'about_delete'              => 'about.destroy',

                'service_view'              => 'service.index',
                'service_create'            => 'service.create',
                'service_edit'              => 'service.edit',
                'service_delete'            => 'service.destroy',

                'feature_view'              => 'feature.index',
                'feature_create'            => 'feature.create',
                'feature_edit'              => 'feature.edit',
                'feature_delete'            => 'feature.destroy',

                'statistic_view'            => 'statistic.index',
                'statistic_create'          => 'statistic.create',
                'statistic_edit'            => 'statistic.edit',
                'statistic_delete'          => 'statistic.destroy',

                'testimonial_view'          => 'testimonial.index',
                'testimonial_create'        => 'testimonial.create',
                'testimonial_edit'          => 'testimonial.edit',
                'testimonial_delete'        => 'testimonial.destroy',

                'faq_view'                  => 'faq.index',
                'faq_create'                => 'faq.create',
                'faq_edit'                  => 'faq.edit',
                'faq_delete'                => 'faq.destroy',

                'pages_view'                => 'pages.index',
                'pages_create'              => 'pages.create',
                'pages_edit'                => 'pages.edit',
                'pages_delete'              => 'pages.destroy',
            ],
        ];
