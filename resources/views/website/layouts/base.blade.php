...
<html lang="en">
    <head>
        ...
        @else
            <link rel="shortcut icon" href="{{ static_asset('images/default/favicon/favicon.png') }}">
        @endif
        ...
        @if(env('WHITE_LEVEL') == 1)
            @if(setting('theme_color') == 'green')
                <link rel="stylesheet" href="{{ static_asset('website/css/theme_color/green.css') }}?v={{ time() }}">
            @elseif(setting('theme_color') == 'blue')
                <link rel="stylesheet" href="{{ static_asset('website/css/theme_color/blue.css') }}?v={{ time() }}">
            @elseif(setting('theme_color') == 'orange')
                <link rel="stylesheet" href="{{ static_asset('website/css/theme_color/orange.css') }}?v={{ time() }}">
            @elseif(setting('theme_color') == 'purple')
                <link rel="stylesheet" href="{{ static_asset('website/css/theme_color/purple.css') }}?v={{ time() }}">
            @endif
        @endif
        @if(app()->getLocale() =='bn')
