                                ...
                                <div class="card-inner">
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number"
                                                    value="{{ old('phone_number') != '' ? old('phone_number') : $merchant->phone_number }}"
                                                    name="phone_number" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="opening_balance">{{ __('opening_balance') }} ({{ setting('default_currency_symbol') }})<span class="text-danger">*</span> <span
