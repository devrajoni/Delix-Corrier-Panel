                                        ...
                                        <div class="row mt-5">
                                            ...
                                            @foreach ($cod_charges as $cod_charge)
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="charge">{{ __($cod_charge->location) }} ({{ setting('default_currency_symbol') }})</label>
                                                                ...
                                                                <table class="table table-bordered role-create-table"
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th scope="col">{{ __('same_day') }} ({{ setting('default_currency_symbol') }})</th>
                                                                            <th scope="col">{{ __('next_day') }} ({{ setting('default_currency_symbol') }})</th>
                                                                            <th scope="col">{{ __('sub_city') }} ({{ setting('default_currency_symbol') }})</th>
                                                                            <th scope="col">{{ __('sub_urban_area') }} ({{ setting('default_currency_symbol') }})
                                                                            </th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
