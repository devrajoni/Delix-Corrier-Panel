                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-success">
                                <p>{{ __('current_payable_balance') }}: <span
                                        id="current-balance" class="currency" data-default-currency="{{ setting('default_currency_symbol') }}">{{ format_price(0) }}</span></p>
                    ...
                    <form action="{{ route('approve-payment') }}" method="POST" class="form-validate is-alter"
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ __('add_to_batch') }}</label>
                                <select class=" without_search form-select form-control withdraw_batches change-batch" name="withdraw_batch">
