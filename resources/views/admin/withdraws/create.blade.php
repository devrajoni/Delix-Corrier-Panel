                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="amount">{{ __('amount') }}({{ setting('default_currency_symbol') }})
                                    ...
                                    <div class="g-gs d-none" id="account-area">
                                        <div class="mb-3">
                                            ...
                                            <div class="text-success">
                                                ...
                                                <input type="hidden" name="current_payable_balance" class="currency" data-default-currency="{{ setting('default_currency_symbol') }}"
