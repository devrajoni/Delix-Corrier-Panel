...
@section('mainContent')
    <section class="oftions">
                    ...
                    <div class="statistics-card bg-white color-success redious-border mb-20 p-20 p-md-20">
                        <div class="row">
                            ...
                            <div class="statistics-footer d-flex align-items-center gap-3">
                                <p class="sales-price">{{ format_price($monthly_total_cod) }}</p>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                    <div class="statistics-card bg-white color-danger redious-border mb-20 p-20 p-sm-20">
                        <div class="row">
                            ...
                            <div class="statistics-footer d-flex align-items-center gap-3">
                                <p class="sales-price">{{ $monthly_total_merchant }}</p>
                                <h6>{{ __('since_last_month') }}</h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                    <div class="statistics-card bg-white color-blue redious-border mb-20 p-20 p-sm-20">
                        <div class="row">
                            ...
                            <div class="statistics-footer d-flex align-items-center gap-3">
                                <p class="sales-price">{{ $monthly_total_parcel_count }}</p>
                                <h6>{{ __('since_last_month') }}</h6>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <table class="table table-borderless best-selling-courses recent-transactions">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">{{ format_price(abs($lifetime_profit['total_charge_vat'])) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start">{{ __('total_delivery_charge') }}</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['total_delivery_charge']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start">{{ __('total_vat') }}</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['total_vat']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start">{{ __('fragile_liquid_charge') }}</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['total_fragile_charge']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start">{{ __('packaging_charge') }}</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['total_packaging_charge']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start bold"><strong>{{ __('total_profit') }}</strong></td>
                                                        <td class="bold text-end">
                                                            <strong>{{ format_price($lifetime_profit['total_profit']) }}</strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div id="payout_table_container">
                                            <table class="table table-borderless best-selling-courses recent-transactions">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ __('total_payout') }}({{ __('cod') }})</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['total_payable_to_merchant']) }}</td>
                                                    </tr>
                                                    <tr>

                                                        <td>{{ __('total_payout_processed') }}</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['processed_payouts']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('total_payout_pending') }}</td>
                                                        <td class="text-end">{{ format_price($lifetime_profit['pending_payouts']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('current_payable_to_merchant') }}
                                                        </td>
                                                        <td class="text-end">
                                                            {{ format_price($lifetime_profit['current_payable']) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bold"><strong>{{ __('current_payable_with_pending') }}</strong>
                                                        </td>
                                                        <td class="bold text-end"><strong>{{ format_price($lifetime_profit['current_payable'] + $lifetime_profit['pending_payouts']) }}</strong>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                    ...
                    <div class="statistics-card bg-white redious-border mb-4 pt-20 p-30">
                        <div class="section-top">
                            ...
                            <div class="statistics-view dropdown pe-4">
                                <a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown" id="today_earning" aria-expanded="false">
                                    {{ __('today') }}
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="today" id="today_earning" href="#">
                                            {{ __('today') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="yesterday" id="yesterday_earning" href="#">
                                            {{ __('yesterday') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="last_7_day" id="last_7_day_earning" href="#">
                                            {{ __('last_7_day') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="last_14_day" id="last_14_day_earning" href="#">
                                            {{ __('last_14_day') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="last_month" id="last_month_earning" href="#">
                                            {{ __('last_month') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="last_6_month" id="last_6_month_earning" href="#">
                                            {{ __('last_6_month') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="this_year" id="this_year_earning" href="#">
                                            {{ __('this_year') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item __js_earning_filterable_item" data-filter="last_12_month" id="last_12_month_earning" href="#">
                                            {{ __('last_12_month') }}
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="analytics clr-1 mb-40">
                                        ...
                                        <div class="analytics-content">
                                            <p>{{ __('income') }}</p>
                                            <h4 id="total_income">{{ setting('default_currency_symbol').$total_income}}</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="analytic clr-2 mb-40">
                                        ...
                                        <svg width="32" height="32" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#ff5630"><path d="M318.072 561.493H215.037c-16.962 0-30.72-13.758-30.72-30.72V71.683c0-16.968 13.754-30.72 30.72-30.72h586.598c16.966 0 30.72 13.752 30.72 30.72v459.09c0 16.962-13.758 30.72-30.72 30.72h-96.143c-11.311 0-20.48 9.169-20.48 20.48s9.169 20.48 20.48 20.48h96.143c39.583 0 71.68-32.097 71.68-71.68V71.683c0-39.591-32.094-71.68-71.68-71.68H215.037c-39.586 0-71.68 32.089-71.68 71.68v459.09c0 39.583 32.097 71.68 71.68 71.68h103.035c11.311 0 20.48-9.169 20.48-20.48s-9.169-20.48-20.48-20.48z" fill="#ff5630"/><path d="M291.917 259.95h432.845c11.311 0 20.48-9.169 20.48-20.48s-9.169-20.48-20.48-20.48H291.917c-11.311 0-20.48 9.169-20.48 20.48s9.169 20.48 20.48 20.48z"/><path d="M367.155 250.006c5.819-9.699 2.673-22.279-7.026-28.098s-22.279-2.673-28.098 7.026l-91.709 152.863c-16.887 28.125-.345 57.353 32.471 57.353h36.905c11.311 0 20.48-9.169 20.48-20.48s-9.169-20.48-20.48-20.48h-31.445l88.902-148.184zm237.42 148.184c-11.311 0-20.48 9.169-20.48 20.48s9.169 20.48 20.48 20.48H743.88c32.816 0 49.358-29.229 32.468-57.36l-91.706-152.857c-5.819-9.699-18.399-12.845-28.098-7.026s-12.845 18.399-7.026 28.098l88.902 148.184H604.575zm21.643 604.647V827.59a10.25 10.25 0 014.469-8.456l63.156-43.138a51.182 51.182 0 0022.323-42.286v-95.805c0-11.311-9.169-20.48-20.48-20.48s-20.48 9.169-20.48 20.48v95.805c0 3.394-1.667 6.553-4.459 8.459l-63.166 43.145a51.21 51.21 0 00-22.323 42.276v175.247c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48zM298.036 623.641v108.851a51.18 51.18 0 0024.96 43.967l72.952 43.556a10.243 10.243 0 014.99 8.794v174.029c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48V828.809a51.204 51.204 0 00-24.945-43.958l-72.967-43.565a10.225 10.225 0 01-4.99-8.794V623.641c0-11.311-9.169-20.48-20.48-20.48s-20.48 9.169-20.48 20.48z"/><path d="M716.068 678.681V465.003c0-36.757-29.803-66.56-66.56-66.56h-2.222c-36.757 0-66.56 29.803-66.56 66.56v126.638c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48V465.003c0-14.136 11.464-25.6 25.6-25.6h2.222c14.136 0 25.6 11.464 25.6 25.6v213.678c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48z"/><path d="M621.689 545.519V418.881c0-36.757-29.803-66.56-66.56-66.56h-2.222c-36.757 0-66.56 29.803-66.56 66.56v165.55c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48v-165.55c0-14.136 11.464-25.6 25.6-25.6h2.222c14.136 0 25.6 11.464 25.6 25.6v126.638c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48z"/><path d="M527.876 586.436V372.758c0-36.757-29.803-66.56-66.56-66.56h-2.222c-36.757 0-66.56 29.803-66.56 66.56V536.26c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48V372.758c0-14.136 11.464-25.6 25.6-25.6h2.222c14.136 0 25.6 11.464 25.6 25.6v213.678c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48z"/><path d="M433.444 582.383V418.881c0-36.757-29.803-66.56-66.56-66.56h-2.222c-36.757 0-66.56 29.803-66.56 66.56v213.678c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48V418.881c0-14.136 11.464-25.6 25.6-25.6h2.222c14.136 0 25.6 11.464 25.6 25.6v163.502c0 11.311 9.169 20.48 20.48 20.48s20.48-9.169 20.48-20.48z" fill="#ff5630"/></svg>
                                        </div>

                                        <div class="analytic-content">
                                            <p>{{ __('expense') }}</p>
                                            <h4 id="total_expense">{{ setting('default_currency_symbol').$total_expense }}</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="profit clr-4 mb-40">
                                        ...
                                        <div class="profit-content">
                                            <p>{{ __('profit') }}</p>
                                            <h4 id="total_profit">{{ setting('default_currency_symbol').$total_profit }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="analytics clr-1 mb-40">
                                        ...
                                        <div class="analytics-content">
                                            <p>{{ __('new_parcel') }}</p>
                                            <h4 id="new_parcel">{{ $new_parcel. '/' .setting('default_currency_symbol').$new_parcel_cod }}</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="analytics clr-2 mb-40">
                                        ...
                                        <div class="analytics-content">
                                            ...
                                            <h4 id="processing_parcel">{{ $processing_parcel. '/' .setting('default_currency_symbol').$processing_parcel_cod }}</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="analytics clr-4 mb-40">
                                        ...
                                        <div class="analytics-content">
                                            <p>{{ __('delivered') }}</p>
                                            <h4 id="delivered_parcel">{{ $delivered_parcel. '/'.setting('default_currency_symbol') .$delivered_parcel_cod}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <tbody>
                                                                @foreach($latest_merchants as $latest_merchant)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{route('detail.merchant.personal.info', $latest_merchant->id)}}">
                                                                                <div class="user-info-panel d-flex gap-12 align-items-center">
                                                                                    <div class="user-img">
                                                                                        @if(!blank($latest_merchant->user->image) && file_exists($latest_merchant->user->image->image_small_two))
                                                                                            <img
                                                                                                src="{{static_asset($latest_merchant->user->image->image_small_two)}}"
                                                                        ...
                                                                        <td><span class="text-nowrap">{{ date("F j, Y", strtotime($latest_merchant->created_at))}}</span><br>{{ date("g:i a", strtotime($latest_merchant->created_at)) }}<span></span></td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
                                                            ...
                                                            <tbody>
                                                                @foreach($top_rank_merchants as $top_rank_merchant)
                                                                    <tr>
                                                                        <td>{{ $loop->iteration }}</td>
                                                                        <td>
                                                                            <a href="{{route('detail.merchant.personal.info', $top_rank_merchant->id)}}">
                                                                                <div class="user-info-panel d-flex gap-12 align-items-center">
                                                                                    <div class="user-img">
                                                                                        @if(!blank($top_rank_merchant->user->image) && file_exists($top_rank_merchant->user->image->image_small_two))
                                                                                            <img
                                                                                                src="{{static_asset($top_rank_merchant->user->image->image_small_two)}}"
                                                                        ...
                                                                        <td><span class="text-nowrap">{{ date("F j, Y", strtotime($top_rank_merchant->created_at))}}</span><br>{{ date("g:i a", strtotime($top_rank_merchant->created_at)) }}<span></span></td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
        ...
        <div class="modal fade custom-modal" id="customDateRangeModal" tabindex="-1" aria-labelledby="customDateRangeModalLabel" aria-hidden="true">
        ...
        <div class="modal fade custom-modal" id="customEarningDateRangeModal" tabindex="-1" aria-labelledby="customEarningDateRangeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="customDateRangeModalLabel">Select Custom Date Range</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-gs">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('start_date') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="form-control-wrap focused">
                                        <input type="text" class="form-control date-picker" name="start_date" id="startEarningDate"
                                            value="{{ old('start_date') }}" autocomplete="off" required
                                            placeholder="{{ __('start_date') }}"
                                            value="{{ request()->get('start_date') }}">
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('end_date') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="form-control-wrap focused">
                                        <input type="text" class="form-control date-picker" name="end_date" id="endEarningDate"
                                            value="{{ old('end_date') }}" autocomplete="off" required
                                            placeholder="{{ __('end_date') }}"
                                            value="{{ request()->get('end_date') }}">
                                    </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn sg-btn-primary" id="applyEarningDateRange">{{ __('submit') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('js')
    ...
    <script>
        ...
        var currency         = "{{ setting('default_currency_symbol') }}";
        var currency_symbol  = "{{ setting('default_currency_symbol') }}";
        ...
        function graph(charts) {
            ...
            if (statisticsItem && charts) {
                ...
                var labels             = [];
                var new_parcel         = [];
                var processing_parcel  = [];
                var delivered_parcel   = [];
                ...
                for (var i = 0; i < 12; i++) {
                    ...
                    if (charts.new_parcel && charts.processing_parcel && charts.delivered_parcel) {
                        new_parcel.push(charts.new_parcel[monthIndex]);
                        processing_parcel.push(charts.processing_parcel[monthIndex]);
                        delivered_parcel.push(charts.delivered_parcel[monthIndex]);
                    }
                }
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.__js_earning_filterable_item', function(event) {
                ...
                var ajaxUrlEarningFilter = ajaxUrl + "?filter=" + filter;

                $.ajax({
                    url: ajaxUrlEarningFilter,
                    method: 'GET',
                    success: function(response) {
                        $('#total_income').text(currency_symbol +response.data.total_income);
                        $('#total_expense').text(currency_symbol +response.data.total_expense);
                        $('#total_profit').text(currency_symbol +response.data.total_profit);
                        var charts = response.data.charts;
                        graphs(charts);
                    },
                    error: function(xhr, status, error) {
        ...
        function graphs(charts) {
            ...
            if (statisticsItemEarning && charts) {
                ...
                for (var i = 0; i < 12; i++) {
                    ...
                    var year = startYear + Math.floor((startMonth + i - 1) / 12);
                    labels.push(months[monthIndex] + ' ' + year);
                    if (charts.income && charts.expense && charts.profit) {
                        income.push(charts.income[monthIndex]);
                        expense.push(charts.expense[monthIndex]);
                        profit.push(charts.profit[monthIndex]);
                    }
                }
