                                    ...
                                    <ul class="nk-top-products">
                                        <div class="card-inner p-0">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td><span
                                                            ><strong>{{ __('current_payable') }}</strong></span>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="card-inner p-0">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <span id="shop_phone_number">{{ old('shop_phone_number') ? old('shop_phone_number') : $parcel->pickup_shop_phone_number }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span id="shop_address">{{ old('shop_address') ? old('shop_address') : $parcel->pickup_address }}</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
