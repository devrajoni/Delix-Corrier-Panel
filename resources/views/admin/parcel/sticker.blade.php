...
<body>
    <div class="sticker-print">
        <div class="d-flex justify-content-between  bb hstack gap-3 gp">
            <div class="image">
                <img src="{{ getFileLink('80X80',setting('admin_logo')) }}" alt="{{ setting('system_name') }}" class="img-fluid">
                <p class="mb-0">Call: 01601-057407</p>
            </div>
            <div class="vr"></div>
        ...
        <div class="codes">
            ...
            <div>
                @if(env('WHITE_LEVEL') !='1')
                    <p class="text text-center mt-1">
                        {!! config('white_level_text.text') !!}
                    </p>
                @endif
            </div>
        </div>
