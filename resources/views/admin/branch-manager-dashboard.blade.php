                            ...
                            <div class="col-md-4">
                                <div class="analytics clr-1 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        <p>{{ __('new_parcel') }}</p>
                                        <h4 id="new_parcel">{{ $branch_wise_total_new_parcel. '/' .setting('default_currency_symbol').$branch_wise_total_new_parcel_cod }}</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="analytics clr-2 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        ...
                                        <h4 id="processing_parcel">{{ $branch_wise_total_processing_parcel. '/' .setting('default_currency_symbol').$branch_wise_total_processing_parcel_cod }}</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="analytics clr-4 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        <p>{{ __('delivered') }}</p>
                                        <h4 id="delivered_parcel">{{ $branch_wise_total_delivered_parcel. '/' .setting('default_currency_symbol').$branch_wise_total_delivered_parcel_cod}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function graph(charts) {
        ...
        if (statisticsItem && charts) {
            ...
            for (var i = 0; i < 12; i++) {
                ...
                if (charts.branch_wise_new_parcel && charts.branch_wise_processing_parcel && charts.branch_wise_delivered_parcel) {
                    new_parcel.push(charts.branch_wise_new_parcel[monthIndex]);
                    processing_parcel.push(charts.branch_wise_processing_parcel[monthIndex]);
                    delivered_parcel.push(charts.branch_wise_delivered_parcel[monthIndex]);
                }
            }
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (statisticsItem) {
            ...
            for (var j = 0; j < 12; j++) {
                ...
                totalParcel.push(charts.branch_wise_added_parcel[monthIndex]);
                totalDeliveredParcel.push(charts.branch_wise_delivery_parcel[monthIndex]);
            }
