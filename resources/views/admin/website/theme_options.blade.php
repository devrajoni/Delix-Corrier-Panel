        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    ...
                    <div class="row gx-20">
                            <div class="col-md-12 col-lg-12 input_file_div mb-4">
                                <div class="mb-3">
                                ...
                                <div class="selected-files d-flex flex-wrap gap-20">
                                    <div class="selected-files-item">
                                        <img class="selected-img" src="{{ setting('light_logo') && @is_file_exists(setting('light_logo')['original_image'], setting('default_storage')) ? get_media(setting('light_logo')['original_image'], setting('default_storage')) : get_media('images/default/logo/logo_light.png') }}" alt="light_logo">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12 input_file_div mb-4">
                                ...
                                <div class="selected-files d-flex flex-wrap gap-20">
                                    <div class="selected-files-item">
                                        <img class="selected-img" src="{{ setting('dark_logo') && @is_file_exists(setting('dark_logo')['original_image'], setting('default_storage')) ? get_media(setting('dark_logo')['original_image'], setting('default_storage')) : get_media('images/default/logo/logo_light.png') }}" alt="dark_logo">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12 input_file_div mb-4">
                                ...
                                <div class="selected-files d-flex flex-wrap gap-20">
                                    <div class="selected-files-item">
                                        ...
                                        <img class="selected-img" src="{{ setting('favicon') && @is_file_exists(setting('favicon')['original_image'], setting('default_storage')) ? get_media(setting('favicon')['original_image'], setting('default_storage')) : get_media('images/default/favicon/favicon-96x96.png') }}" alt="dark_logo">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="select-type-v2 mb-4">
                                    ...
                                    <select class="form-select form-select-lg mb-3 with_search"
                                        ...
                                        <option value="0"
                                            {{ setting('website') == 0 ? 'selected' : 'selected' }}>
                                            <span>{{ __('no') }}</span>
                                        </option>
                                        <option value="1"
                                            {{ setting('website') == 1 ? 'selected' : '' }}>
                                            <span>{{ __('yes') }}</span>
                                        </option>
                                    </select>
                                </div>
