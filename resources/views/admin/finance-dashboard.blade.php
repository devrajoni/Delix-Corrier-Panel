...
@section('mainContent')
    ...
    <div class="container-fluid">
                            ...
                            <div class="profit clr-1">
                                <div class="profit-icon p-4">
                                    ...
                                    <div class="profit-content no-line-braek">
                                        <h4 class="own-balance">{{ setting('default_currency_symbol').$finance_self_wallet }}</h4>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-md-6">
                        <div class="statistics-card bg-white redious-border mb-4 p-20 p-sm-30">
                            <div class="analytics clr-1">
                                ...
                                <div class="analytics-content no-line-braek">
                                    <h4>{{ setting('default_currency_symbol').$life_time_total_cod }}</h4>
                                    <p>{{__('cod')}}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade custom-modal" id="applyIncomeDateRangeModal" tabindex="-1" aria-labelledby="customDateRangeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="customDateRangeModalLabel">Select Custom Date Range</h5>
    ...
    <script>
        ...
        function incomeGraph(charts) {
            ...
            if (statisticsIncomeItem && charts) {
                ...
                var totalCharge = [];
                var totalVas = [];
                var totalCashCollect = [];
                for (var j = 0; j < 12; j++) {
                    var monthIndex = (startMonth + j - 1) % 12;
                    totalCharge.push(charts.charge[monthIndex]);
                    totalVas.push(charts.vas[monthIndex]);
                    totalCashCollect.push(charts.cashFromMerchant[monthIndex]);
                }
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    ...
                                    label += "{{ setting('default_currency_symbol') }}" + context.raw;
                                    return label;
                                }
                            }
                        }
