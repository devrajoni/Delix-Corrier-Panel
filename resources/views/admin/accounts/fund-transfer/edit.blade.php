                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-inner">
                                    <div class="mb-3">
                                        ...
                                        <div class="text-success">
                                            <p>{{ __('current_payable_balance') }}: <span
                                                    id="current-balance">{{ setting('default_currency_symbol') }}{{ $balance }}</span>
                                            </p>
                                            <input type="hidden" name="payable_balance" class="currency" data-default-currency="{{ setting('default_currency_symbol') }}" id="payable_balance">
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="fv-full-name">{{ __('amount') }} ({{ setting('default_currency_symbol') }})<span
                                                class="text-danger">*</span></label>
