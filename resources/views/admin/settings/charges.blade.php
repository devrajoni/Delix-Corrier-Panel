                                ...
                                <div class="col-md-12">
                                    <div class="card-inner">
                                        <div class="row g-gs">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label" for="return_charge_city">{{ __('city') }} ({{ setting('default_currency_symbol') }})
                                                        <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label" for="return_charge_sub_city">{{ __('sub_city') }} ({{ setting('default_currency_symbol') }})
                                                        <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="return_charge_outside_dhaka">{{ __('sub_urban_area') }} ({{ setting('default_currency_symbol') }})
                                                        <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label" for="fragile_charge">{{ __('fragile_charge') }} ({{ setting('default_currency_symbol') }}) <span
                            ...
                            <form action="{{ route('update.charge') }}" method="POST">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered role-create-table mt-3"
                                        ...
                                        <thead>
                                            <tr>
                                                <th scope="col">{{ __('weight') }} ({{ setting('default_unit') }})</th>
                                                <th scope="col">{{ __('same_day') }} ({{ __('same_city') }} {{ setting('default_currency_symbol') }})</th>
                                                <th scope="col">{{ __('next_day') }} ({{ __('same_city') }} {{ setting('default_currency_symbol') }})</th>
                                                <th scope="col">{{ __('sub_city') }} ({{ setting('default_currency_symbol') }})</th>
                                                <th scope="col">{{ __('sub_urban_area') }} ({{ setting('default_currency_symbol') }})</th>
                                            </tr>
                                        </thead>
                                        <tbody id="charge">
