                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 25px 80px 15px 80px;">
                                    ...
                                    @if(isset($otp_number) && !empty($otp_number))
                                        <a href="{{ $reset_link }}" style="background-color:#4c83ee;border-radius:6px;color:#ffffff;display:inline-block;font-size:15px;font-weight:500;text-align:center;text-decoration:none;text-transform: capitalize; padding: 10px 30px;">{{ $otp_number }}</a>
                                    @else
