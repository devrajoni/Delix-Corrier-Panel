                ...
                <div class="bg-white redious-border pt-30 p-20 p-sm-30">
                    <form action="{{ route('otp.setting') }}" method="post" class="form">@csrf
                        <div class="row gx-20">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex flex-wrap">
                                    <div class="custom-radio me-40 mb-20">
                                        <label>
                                            <input type="radio" value="twillio"
                                                   name="active_sms_provider" {{ env('PROVIDER') == 'twillio' || !env('PROVIDER') ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-radio me-40 mb-20">
                                        <label>
                                            <input type="radio" name="active_sms_provider"
                                                   value="fast2" {{ env('PROVIDER') == 'fast2' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-radio me-40 mb-20">
                                        <label>
                                            <input type="radio" name="active_sms_provider"
                                                   value="spagreen" {{ env('PROVIDER') == 'spagreen' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-radio me-40 mb-20">
                                        <label>
                                            <input type="radio" name="active_sms_provider"
                                                   value="mimo" {{ env('PROVIDER') == 'mimo' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-radio me-40 mb-20">
                                        <label>
                                            <input type="radio" name="active_sms_provider"
                                                   value="nexmo" {{ env('PROVIDER') == 'nexmo' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-radio me-40 mb-20">
                                        <label>
                                            <input type="radio" name="active_sms_provider"
                                                   value="ssl_wireless" {{ env('PROVIDER') == 'ssl_wireless' ? 'checked' : '' }}>
                            ...
                            <div
                                class="col-lg-12 twillio_div {{ env('PROVIDER') == 'twillio' || !env('PROVIDER') ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div
                                class="col-lg-12 fast2_div {{ env('PROVIDER') == 'fast2' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div
                                class="col-lg-6 fast2_div {{ env('PROVIDER') == 'fast2' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div
                                class="col-lg-12 spagreen_div {{ env('PROVIDER') == 'spagreen' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div class="col-lg-12 spagreen_div  {{ env('PROVIDER') == 'spagreen' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div class="col-lg-12 mimo_div  {{ env('PROVIDER') == 'mimo' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div
                                class="col-lg-12 mimo_div {{ env('PROVIDER') == 'mimo' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div
                                class="col-lg-12 nexmo_div {{ env('PROVIDER') == 'nexmo' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div
                                class="col-lg-12 ssl_wireless_div {{ env('PROVIDER') == 'ssl_wireless' ? '' : 'd-none' }}">
                                <div class="mb-4">
                            ...
                            <div class="col-lg-12 ssl_wireless_div {{ env('PROVIDER') == 'ssl_wireless' ? '' : 'd-none' }}">
                                <div class="mb-4">
