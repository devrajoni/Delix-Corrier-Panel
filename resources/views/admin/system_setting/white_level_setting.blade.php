    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
            <div class="col col-xxl-8 ">
                <h3 class="section-title">{{ __('white_level_setting') }}</h3>
                <div class="bg-white redious-border pt-30 p-20 p-sm-30">
                    <div class="section-top">
                        <h6>{{ __('white_level_setting') }}</h6>
                    </div>

                    <form action="{{ route('admin.white-level.setting') }}" method="post"  enctype="multipart/form-data">@csrf
                        ...
                        <div class="row gx-20">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control rounded-2" id="admin_panel_title"
                                           placeholder="{{__('title') }}" name="system_name" value="{{ old('system_name', setting('system_name', $lang) ) }}">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="select-type-v2">
                                    <select class="form-select with_search" name="theme_color" id="theme_color">
                                        <option value="red" {{ setting('theme_color') == 'red' ?  'selected' : '' }}>{{ __('red') }}</option>
                                        <option value="green" {{ setting('theme_color') == 'green' ?  'selected' : '' }}>{{ __('green') }}</option>
                                        <option value="blue" {{ setting('theme_color') == 'blue' ?  'selected' : '' }}>{{ __('blue') }}</option>
                                        <option value="orange" {{ setting('theme_color') == 'orange' ?  'selected' : '' }}>{{ __('orange') }}</option>
                                        <option value="purple" {{ setting('theme_color') == 'purple' ?  'selected' : '' }}>{{ __('purple') }}</option>
                                    </select>
                                    <div class="nk-block-des text-danger">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 input_file_div mb-4">
                                ...
                                <div class="selected-files d-flex flex-wrap gap-20">
                                    <div class="selected-files-item">
                                        <img class="selected-img" src="{{ getFileLink('80X80',setting('admin_favicon')) }}" alt="favicon">
                                    </div>
                                </div>
                            </div>
