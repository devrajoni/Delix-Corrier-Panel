            ...
            <div class="col col-lg-8 col-md-9">
                <div class="bg-white redious-border pt-30 p-20 p-sm-30">
                    ...
                    <div class="card-body">
                        ...
                        <label for="cron_command" class="form-label">{{ __('sms_status_update') }}</label>
                        <div class="input-group">
                            <input type="text"
                                   value="wget -q -O- {{ route('sms.status.update') }}"
                                   readonly
                                   class="form-control"
                                   placeholder="{{ __('cron_command') }}"
                                   aria-label="{{ __('cron_command') }}"
                        ...
                        <div class="text-center">
                            <a href="{{ route('sms.status.update') }}" class="btn btn-sm sg-btn-primary gap-2 mt-20 mb-20">
                                <span>{{ __('run_cron_manually') }}</span>
                            </a>
                        </div>
                    </div>
