    ...
    <div class="payment-box">
        ...
        <div class="payment-settings">
            ...
            <div class="setting-check">
                <input type="checkbox" id="ssl_wireless" name="active_sms_provider" value="ssl" data-url="{{ route('otp-status') }}" class="sms-status-change" {{ env('PROVIDER') == 'ssl' ? 'checked' : '' }}>
...
<!-- End Payment box -->
<div class="modal fade" id="sslWireless" tabindex="-1" aria-labelledby="paymentMethodLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('otp.setting') }}" method="post">@csrf
                <input type="hidden" value="ssl" name="provider">
                ...
                <div class="row gx-20">
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" id="SSLWirelessKey" required name="ssl_sms_api_token" value="{{ isDemoMode() ? '******************' : stringMasking(env('ssl_sms_api_token'),'*',3) }}">
                    ...
                    <div class="col-lg-12 ssl_wireless_div">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" id="SSLWirelessSecret" required name="ssl_sms_sid" value="{{ isDemoMode() ? '******************' : stringMasking(env('ssl_sms_sid'),'*',3) }}">
                            <div class="nk-block-des text-danger">
                    ...
                    <div class="col-lg-12 ssl_wireless_div">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" required id="ssl_sms_url" name="ssl_sms_url" value="{{ isDemoMode() ? '******************' : stringMasking(env('ssl_sms_url'),'*',3) }}">
                            <div class="nk-block-des text-danger">
