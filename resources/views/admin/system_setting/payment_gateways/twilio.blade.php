    ...
    <div class="payment-box">
        ...
        <div class="payment-settings">
            ...
            <div class="setting-check">
                <input type="checkbox" id="twilio_system" name="active_sms_provider" value="twilio" data-url="{{ route('otp-status') }}" class="sms-status-change" {{ env('PROVIDER') == 'twilio' ? 'checked' : '' }}>
...
<!-- End Payment box -->
<div class="modal fade" id="twilio" tabindex="-1" aria-labelledby="paymentMethodLabel" aria-hidden="true">
                ...
                <div class="row gx-20">
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" id="twilioSID" required name="twilio_sms_sid" value="{{ isDemoMode() ? '******************' : stringMasking(env('twilio_sms_sid'),'*',3,-3) }}">
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" required name="twilio_sms_auth_token" id="twilioAuthToken" value="{{ isDemoMode() ? '******************' : stringMasking(env('twilio_sms_auth_token'),'*',3,-3) }}">
                            <div class="nk-block-des text-danger">
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" id="validTwilioNumber" required name="valid_twilio_sms_number" value="{{ isDemoMode() ? '******************' : stringMasking(env('TWILIO_SMS_NUMBER'),'*',3,-3) }}">
                            <div class="nk-block-des text-danger">
