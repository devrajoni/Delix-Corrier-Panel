    ...
    <div class="payment-box">
        ...
        <div class="payment-settings">
            ...
            <div class="setting-check">
                <input type="checkbox" id="nexmo_system" name="active_sms_provider" value="nexmo" data-url="{{ route('otp-status') }}" class="sms-status-change" {{ env('PROVIDER') == 'nexmo' ? 'checked' : '' }}>
...
<!-- End Payment box -->
<div class="modal fade" id="nexmo" tabindex="-1" aria-labelledby="paymentMethodLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <h6 class="sub-title">{{ __('nexmo') }} {{ __('configuration') }}</h6>
            <button type="button" class="btn-close modal-close" data-bs-dismiss="modal" aria-label="Close"></button>
            <form action="{{ route('otp.setting') }}" method="post">@csrf
                <input type="hidden" value="nexmo" name="provider">
                ...
                <div class="row gx-20">
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" required id="NexmoKey" name="nexmo_sms_key" value="{{ isDemoMode() ? '******************' : stringMasking(env('nexmo_sms_key'),'*',3) }}">
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" required id="NexmoSecret" name="nexmo_sms_secret_key" value="{{ isDemoMode() ? '******************' : stringMasking(env('nexmo_sms_secret_key'),'*',3) }}">
                            <div class="nk-block-des text-danger">
