    ...
    <div class="payment-box">
        ...
        <div class="payment-settings">
            ...
            <div class="setting-check">
                <input type="checkbox" id="mimo_system" name="active_sms_provider" value="mimo" data-url="{{ route('otp-status') }}" class="sms-status-change" {{ env('PROVIDER') == 'mimo' ? 'checked' : '' }}>
...
<!-- End Payment box -->
<div class="modal fade" id="mimo" tabindex="-1" aria-labelledby="paymentMethodLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <h6 class="sub-title">{{ __('mimo') }} {{ __('configuration') }}</h6>
            <button type="button" class="btn-close modal-close" data-bs-dismiss="modal" aria-label="Close"></button>
            <form action="{{ route('otp.setting') }}" method="post">@csrf
                <input type="hidden" value="mimo" name="provider">

                <div class="row gx-20">
                    <div class="col-lg-12 mimo_div">
                        <div class="mb-4">
                            <label for="MIMOUsername" class="form-label">{{ __('mimo_username') }}</label>
                            <input type="text" class="form-control rounded-2" required id="MIMOUsername" name="mimo_username" value="{{ isDemoMode() ? '******************' : stringMasking(env('mimo_username'),'*',3) }}">
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" required id="MIMOPassword" name="mimo_sms_password" value="{{ isDemoMode() ? '******************' : stringMasking(env('mimo_sms_password'),'*',3) }}">
                            <div class="nk-block-des text-danger">
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-2" required id="MIMOSenderID" name="mimo_sms_sender_id" value="{{ isDemoMode() ? '******************' : stringMasking(env('mimo_sms_sender_id'),'*',3) }}">
                            <div class="nk-block-des text-danger">
