...
{{--                                                                    <td>--}}
{{--                                                                        <div class="setting-check">--}}
{{--                                                                            <input disabled type="checkbox" data-id="{{ $event->id }}" data-url="{{ route('sms.sms-masking-status') }}"--}}
{{--                                                                                class="disable custom-control-input {{ hasPermission('sms_setting_update') ? 'status-change-for' : '' }}"--}}
