                        ...
                        <div class="col-md-8">
                            <div class="card bg-white redious-border p-20 p-sm-30 pt-sm-30">
                                <div class="row g-gs">
                                    ...
                                    <div class="col-md-6 mb-3">
                                            <label class="form-label"
                                                for="fv-full-name">{{ __('cash_collection') }} ({{ setting('default_currency') }})
                                                <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                            <label class="form-label"
                                                for="fv-full-name">{{ __('selling_price') }} ({{ setting('default_currency') }})</label>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($shops as $shop)
                                                        <option value="{{ $shop->id }}"
                                                            {{ @$parcel->shop_id == $shop->id ? 'selected' : ($shop->default ? 'selected' : '') }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"
                                            ...
                                            <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control @error('customer_phone_number') is-invalid @enderror"
                                    ...
                                    class="col-md-6 mb-3">
                                        <label class="form-label"
                                            ...
                                            <select
                                                class="without_search form-select form-control packaging"
                                                name="packaging">
                                ...
                                <ul class="nk-top-products">
                                    <div class="card-inner p-0">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td><span
                                                        class="sub-text" id="currency" data-default-currency="{{ setting('default_currency') }}"><strong>{{ __('current_payable') }}</strong></span>
                                                </td>
                                                <td><span class="sub-text"><strong
                                                    id="current-payable-charge"> {{ setting('default_currency') }} {{ isset($parcel) ? $parcel->payable : '0.00' }}</strong></span>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
