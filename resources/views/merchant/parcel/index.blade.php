                        ...
                        <a href="#" class="d-flex align-items-center btn sg-btn-primary gap-2" id="filterBTN">
                            ...
                            @if (@settingHelper('preferences')->where('title', 'create_parcel')->first()->merchant)
                                <a href="{{ Sentinel::getUser()->user_type == 'merchant' ? route('merchant.import.csv') : route('merchant.staff.import.csv') }}"
                                    class="d-flex align-items-center btn sg-btn-primary gap-2 @if($currentParcelsCount >= $parcelLimit) disabled @endif"><i
                            ...
                            {{-- <form action="#" id="filterForm"> --}}
                                <div class="row gx-6 gy-3">
                                    <div class="col-3">
                                        ...
                                        <input type="text" class="form-control filterable" id="customer_name" name="customer_name" placeholder="{{__('enter').'  '.__('customer_name')}}">
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="text" class="form-control filterable" id="phone_number" name="phone_number" placeholder="{{__('enter').' '.__('phone_number')}}">
                                    </div>
                                    <div class="col-3">
                                        <label class="form-label" for="created_from">{{ __('created_from') }}</label>
                                        <input type="text" name="created_from" id="created_from" class="form-control date-range filterable" placeholder="YYYY-MM-DD to YYYY-MM-DD" id="created_from">
                                    </div>
                                    <div class="col-3">
                                        <label class="form-label" for="created_to">{{ __('created_to') }}</label>
                                        <input type="text" name="created_to" id="created_to" class="form-control date-range filterable" placeholder="YYYY-MM-DD to YYYY-MM-DD" id="created_to">
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <select
                                            class="without_search form-select form-select-sm filterable"
                ...
                <div class="modal-body">
                    ...
                    @csrf
                       <input type="hidden" name="id" value="" id="cancel-parcel-id">
                        <div class="mb-3">
                            <label class="form-label" for="area">{{ __('cancel_note') }} <span class="text-danger">*</span></label>
   ...
   @include('merchant.parcel.change-parcel-status')
    <script>
        ...
        $(document).on('click', '#download', function() {
            ...
            const created_from = $('#created_from').val();
            const created_to = $('#created_to').val();
