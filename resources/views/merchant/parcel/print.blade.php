                        ...
                        <div class="col-xxl-12 col-sm-12 col-md-12">
                            <div class="card p-2 m-2">
                                <div class="justify-content-between d-inline-flex page-header">
                                    ...
                                    <p class="section-title date">{{ __('date').' '.date('d.m.Y') }}</p>
                                </div>
                                <table class="table">
                                    <tr>
                                        <td class="font-weight-bold ps-0" style="font-size: 20px; padding-left: 0 !important;">{{ __('phone') }}: {{ setting('phone') }}</td>
                                        {{-- <td></td> --}}
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold ps-0" style="font-size: 20px;  padding-left: 0 !important;">{{ __('address') }}: {{ setting('address') }}</td>
                                        {{-- <td> <br></td> --}}
                                    </tr>
                                </table>
                                ...
                                <div class="mt-3">
                                    <div class="cod-invoice d-flex ">
                                        <div class="font-weight-bold p-2 ms-0" style="font-size: 18px;">{{ __('invno') }}:
                                            #{{$parcel->customer_invoice_no}}</div>
                                        <div class="font-weight-bold p-2 me-0" style="font-size: 18px;">{{ __('COD') }}
                                    ...
                                    <div class="border">
                                        <div class="d-inline-flex print-table gap-3">
                                            ...
                                            <table class="m-2">
                                                ...
                                                <tr>
                                                    <td>{{__('weight').': '. $parcel->weight.' '.__(setting('default_unit'))}}</td>
                                                </tr>
                                                <tr>
