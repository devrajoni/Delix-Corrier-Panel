                            ...
                            <div class="card redious-border p-20 p-sm-30 pt-sm-30">
                                <div class="row g-gs">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('customer_invoice_no') is-invalid @enderror" id="customer_invoice_no"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" for="fv-full-name">{{ __('weight') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"
                                            for="fv-full-name">{{ __('cod') . ' ' . __('amount') }}({{ setting('default_currency_symbol') }})<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control cash-collection @error('price') is-invalid @enderror" id="fv-full-name"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"
                                            for="fv-full-name">{{ __('selling_price') }} ({{ setting('default_currency_symbol') }})</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        data-url="{{ Sentinel::getUser()->user_type == 'merchant' ? route('merchant.shop') : route('merchant.staff.shop') }}" name="shop">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"
                                            ...
                                            <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('customer_phone_number') is-invalid @enderror" id="customer_phone_number"
                                    ...
                                    <div class="card-inner p-0">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <th><span
                                                        class="sub-text"><strong>{{ __('amount') }}({{ setting('default_currency_symbol') }})</strong></span>
                                                </th>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td><span
                                                        class="sub-text" id="currency" data-default-currency="{{ setting('default_currency_symbol') }}"><strong>{{ __('current_payable') }}</strong></span>
                                                </td>
                                                <td><span class="sub-text"><strong
                                                            id="current-payable-charge">{{ setting('default_currency_symbol') }} {{ isset($parcel) ? $parcel->payable : '0.00' }}</strong></span>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="card-inner p-0">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    <span id="shop_pickup_branch">{{ old('pickup_branch_id') ? old('pickup_branch_id') : (@$parcel->pickupBranch->name ? @$parcel->pickupBranch->name  : '' ) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
