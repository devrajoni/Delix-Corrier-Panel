                            ...
                            <table class="table">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>{{ __('charge') }}({{ __(setting('default_currency_symbol')) }})
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table class="table">
                                <thead class="thead-light">
                                    <tr class="delivery-charge">
                                        <th>{{ __('weight') }} ({{ __(setting('default_unit')) }})
                                        </th>
                                        <th>{{ __('same_day') }} ({{ __('same_city') }} {{ __(setting('default_currency_symbol')) }})
                                        </th>
                                        <th>{{ __('next_day') }} ({{ __('same_city') }} {{ __(setting('default_currency_symbol')) }})
                                        </th>
                                        {{-- <th><span class="overline-title">{{__('frozen')}}</span></th> --}}
                                        <th>{{ __('sub_city') }} ({{ __(setting('default_currency_symbol')) }})
                                        </th>
                                        <th>{{ __('sub_urban_area') }} ({{ __(setting('default_currency_symbol')) }})
                                        </th>
                                        <th><span class="overline-title">{{__('third_party_booking')}} ({{ __(setting('default_currency_symbol')) }})</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
