                ...
                <div class="header-top d-flex justify-content-between align-items-center">
                        ...
                        <div class="oftions-content-right">
                            @if (@settingHelper('preferences')->where('title', 'create_parcel')->first()->merchant)
                                <a href="{{ route('merchant.parcel.create') }}" class="btn sg-btn-primary d-md-inline-flex @if($currentParcelsCount >= $parcelLimit) disabled @endif"><i
                                ...
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col"><span
                                                class="sub-text"><strong>{{ __('no') }}</strong></span></div>
                                        ...
                                        <div class="nk-tb-item" id="row_{{ $parcel->id }}">
                                            ...
                                            <div class="nk-tb-col column-max-width">
                                                ...
                                                @elseif($parcel->status == 're-schedule-pickup')
                                                    <span
                                                        class="badge text-purple">{{ __('re-schedule-pickup') }}</span><br>
                                                @elseif($parcel->status == 'received-by-pickup-man')
                                                    <span
                                                        class="badge text-yale">{{ __('received-by-pickup-man') }}</span><br>
                                                @elseif($parcel->status == 'received')
                                                    <span
                                                        class="badge text-blue">{{ __('received_by_warehouse') }}</span><br>
                                                @elseif($parcel->status == 'transferred-to-branch')
                                                    <span
                                                        class="badge text-pigeon">{{ __('transferred-to-branch') }}</span><br>
                                                ...
                                                @elseif($parcel->status == 'delivery-assigned')
                                                    <span
                                                        class="badge text-pear">{{ __('delivery-assigned') }}</span><br>
                                                @elseif($parcel->status == 're-schedule-delivery')
                                                    <span
                                                        class="badge text-brown">{{ __('re-schedule-delivery') }}</span><br>
                                                @elseif($parcel->status == 'returned-to-warehouse')
                                                    @if ($parcel->is_partially_delivered)
                                                        <span
                                                            class="badge text-mint">{{ __('partially-delivered') }}</span><br>
                                                    @endif
                                                    <span
                                                        class="badge text-warning">{{ __('returned-to-warehouse') }}</span><br>
                                                ...
                                                @elseif($parcel->status == 'delivered-and-verified')
                                                    <span
                                                        class="badge text-success">{{ __('delivered-and-verified') }}</span><br>
                                                @elseif($parcel->status == 'returned-to-merchant')
                                                    ...
                                                    @endif
                                                    <span
                                                        class="badge text-success">{{ __('returned-to-merchant') }}</span><br>
                                                @elseif($parcel->status == 're-request')
                                                    <span class="badge text-warning">{{ __('re-request') }}</span><br>
                                                @endif
                                                <span
                                                    class="badge text-info">{{ __($parcel->parcel_type) }}</span><br><br>
                                            ...
                                            <div class="nk-tb-col ">
                                                ...
                                                <div class="tb-odr-btns d-md-inline">
                                                    <a href="{{ route('merchant.parcel.print', $parcel->id) }}"
                                                        target="_blank" class="btn btn-sm btn-warning btn-tooltip"
                                                ...
                                                @if ($parcel->status == 'cancel')
                                                    <div class="tb-odr-btns d-md-inline">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-original-title="{{ __('re_request') }}"
                                                            id="parcel-re-request" data-toggle="modal"
                                                            data-target="#re-request-parcel"><i
    ...
    <div class="modal fade" tabindex="-1" id="re-request-parcel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('merchant.parcel.re-request') }}" method="POST"
