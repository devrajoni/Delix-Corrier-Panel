                            ...
                            <div class="profit clr-1">
                                <div class="profit-icon p-4">
                                    ...
                                    <div class="profit-content no-line-braek">
                                        <h4 class="own-balance">{{ format_price(\Sentinel::getUser()->staffMerchant->payableBalance(\Sentinel::getUser()->staffMerchant->id)) }}</h4>
                                        <p>{{ __('unpaid_amount') }}</p>
                                    </div>
                            </div>
                        ...
                        <div class="statistics-card bg-white redious-border mb-4 p-20 p-sm-30">
                            <div class="analytics clr-5">
                                ...
                                <div class="analytics-content no-line-braek">
                                    <h4>{{ setting('default_currency_symbol').$total_cod }}</h4>
                                    <p>{{__('total_cod')}}</p>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($latest_parcels as $parcel)
                                                            <tr>
                                                                <td>
                                                                    <div class="user-name">
                                                                        <a class="opacity-75" href="{{ route('merchant.parcel.detail', $parcel->id) }}">
                                            ...
                                            <div class="col-lg-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="title text-info">{{ $withdraw->withdraw_id }}</span>
                                                            </td>
                                                            <td>
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (statisticsItem) {
            ...
            var totalParcel = [];
            var totalDeliveredParcel = [];
            for (var j = 0; j < 12; j++) {
                var monthIndex = (startMonth + j - 1) % 12;
                totalParcel.push(charts.total_parcel[monthIndex]);
                totalDeliveredParcel.push(charts.total_delivered_parcel[monthIndex]);
            }
