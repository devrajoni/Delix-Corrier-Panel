...
//             url: url,
//             success: function (data) {
//                 $('#shop_pickup_branch').te(data['shop_pickup_branch']);
...
$(document).ready(function() {
    $(document).on('change', '.select-shop', function (e) {
        ...
        $.ajax({
            ...
            url: url,
            success: function (data) {
                $('#shop_pickup_branch').text(data.shop_pickup_branch);
                $('#shop_phone_number').text(data.shop_phone_number);
                $('#shop_address').text(data.address);
            },
            error: function (jqXHR) {
                console.error('Error:', jqXHR.status, jqXHR.statusText, jqXHR.responseText);
            }
        });
    });
    ...
    $(document).on('change', '.select-merchant', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Automatically trigger the shop change after updating the merchant
                $('.select-shop').change();
            },
            error: function (jqXHR) {
                console.error('Error:', jqXHR.status, jqXHR.statusText, jqXHR.responseText);
