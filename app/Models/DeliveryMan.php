...
class DeliveryMan extends Model
{
    ...
    {
        $total_income  = DeliveryManAccount::where('delivery_man_id', $id)->whereNotIn('source',['pickup_commission', 'parcel_delivery', 'opening_balance'])->where('type','income')->sum('amount');
