    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row){
            ...
            $parcel = Parcel::create([
                ...
                'pickup_branch_id'          => $row['pickup_branch'] ?? ($merchant->shops->where('default', true)->first()->pickup_branch_id !='' ? $merchant->shops->where('default', true)->first()->pickup_branch_id : null),
