...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'isWebsite'                      => \App\Http\Middleware\WebsiteCheck::class,
        ...
        'GlobalPermissionCheck'          => \App\Http\Middleware\GlobalPermissionCheck::class,
        'panelPermission'                => \App\Http\Middleware\AdminPanelSettingPermission::class,
        ...
        // 'isInstalled'                    => InstallCheckMiddleware::class,
         ...
         'SaaSAdmin.apikey'                          => \App\Http\Middleware\ControlPanelCheckApiKey::class,
         'systemSettingCheck'                        => \App\Http\Middleware\SystemInfoCheckMiddleware::class,
         'expireDateCheck'                           => \App\Http\Middleware\PackageExpiredCheck::class,
