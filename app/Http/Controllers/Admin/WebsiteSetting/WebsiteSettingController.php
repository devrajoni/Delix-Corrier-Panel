...
class WebsiteSettingController extends Controller
{
    ...
    public function recaptcha(): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            return view('admin.system_setting.recaptcha');
        } catch (\Exception $e) {
            Toastr::error($e->getMessage());
